...
* #chr-0122-0001 "Time to first breastfeeding"
  * ^designation[0].language = #en
  * ^designation[=].value = "Time to first breastfeeding"
  * ^designation[+].language = #ru
  * ^designation[=].value = "Время до первого прикладывания к груди"
  * ^designation[+].language = #uz
  * ^designation[=].value = "Birinchi emizishgacha bo'lgan vaqt"

* #chr-0122-0002 "Reason for not breastfeeding"
  * ^designation[0].language = #en
  * ^designation[=].value = "Reason for not breastfeeding"
  * ^designation[+].language = #ru
  * ^designation[=].value = "Причина отсутствия грудного вскармливания"
  * ^designation[+].language = #uz
  * ^designation[=].value = "Emizilmaslik sababi"

* #chr-0122-0003 "Duration of skin-to-skin contact"
  * ^designation[0].language = #en
  * ^designation[=].value = "Duration of skin-to-skin contact"
  * ^designation[+].language = #ru
  * ^designation[=].value = "Продолжительность контакта кожа к коже"
  * ^designation[+].language = #uz
  * ^designation[=].value = "Teri-teriga kontakt davomiyligi"

* #chr-0122-0004 "Skin-to-skin contact between mother and newborn"
  * ^designation[0].language = #en
  ...
  * ^designation[+].language = #uz
  * ^designation[=].value = "Ona va chaqaloqning teri-teriga kontakti"

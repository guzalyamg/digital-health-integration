...
* #chr-0100-0001 "0 points — no respiratory distress"
  ...
  * ^designation[=].value = "0 ball — nafas yetishmovchiligi yo'q"

* #chr-0100-0002 "1–3 points — initial signs"
  * ^designation[0].language = #en
  * ^designation[=].value = "1–3 points — initial signs"
  * ^designation[+].language = #ru
  * ^designation[=].value = "1–3 балла — начальные признаки"
  * ^designation[+].language = #uz
  * ^designation[=].value = "1–3 ball — boshlang'ich belgilar"

* #chr-0100-0003 "4–6 points — moderate severity"
  * ^designation[0].language = #en
  * ^designation[=].value = "4–6 points — moderate severity"
  * ^designation[+].language = #ru
  * ^designation[=].value = "4–6 баллов — средняя тяжесть"
  * ^designation[+].language = #uz
  * ^designation[=].value = "4–6 ball — o'rtacha og'irlik"

* #chr-0100-0004 "More than 6 points — severe"
  * ^designation[0].language = #en
  * ^designation[=].value = "More than 6 points — severe"
  * ^designation[+].language = #ru
  * ^designation[=].value = "Более 6 баллов — тяжёлая степень"
  * ^designation[+].language = #uz
  * ^designation[=].value = "6 balldan yuqori — og'ir"
